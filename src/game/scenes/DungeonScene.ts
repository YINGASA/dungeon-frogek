...
const REWARD_POOL: RewardOption[] = [
  ...
  { id: 'still-shield-loop', name: '静盾回流', rarity: 'epic', type: '生存', description: '护盾吸收伤害时会回流少量生命，适合稳健防守。', effectText: '护盾吸收后回复 2 生命', apply: (scene) => { scene.relicState.shieldAbsorbHeal += 2; } },
  { id: 'ember-bandage', name: '余烬绷带', rarity: 'common', type: '回复', description: '清理战斗后，绷带会借余温封住轻伤。', effectText: '战斗清房生命 +2', apply: (scene) => { scene.relicState.roomClearHeal += 2; } },
  { id: 'battlefield-suture', name: '战场缝线', rarity: 'rare', type: '回复', description: '每次战斗结束后快速处理伤口，回复量不高但很稳定。', effectText: '战斗清房生命 +3', apply: (scene) => { scene.relicState.roomClearHeal += 3; } },
  ...
  { id: 'sharp-blade', name: '锋利剑刃', rarity: 'common', type: '攻击', description: '剑刃重新开锋，普通攻击与冲刺斩基础伤害提高。', effectText: '攻击 +2', apply: (scene) => { scene.player.stats.atk += 2; } },
  { id: 'attack-crystal', name: '攻击晶石', rarity: 'rare', type: '攻击', description: '源晶强化武器核心，但出现频率较低。', effectText: '攻击 +3', apply: (scene) => { scene.player.stats.atk += 3; } },
  ...
  { id: 'defense-charm', name: '防御护符', rarity: 'common', type: '生存', description: '稳定的护符让正面承伤更可靠。', effectText: '防御 +1', apply: (scene) => { scene.player.stats.def += 1; } },
  { id: 'life-crystal', name: '生命结晶', rarity: 'rare', type: '生存', description: '提升最大生命，并立即回复同等生命。', effectText: '最大生命 +15，回复 15 生命', apply: (scene) => { scene.player.stats.maxHp += 15; scene.player.stats.hp = Math.min(scene.player.stats.maxHp, scene.player.stats.hp + 15); } },
  ...
  { id: 'small-potion', name: '小型生命药水', rarity: 'common', type: '回复', description: '立即饮用的应急药剂。', effectText: '立即回复 22 生命', stackable: true, apply: (scene) => { scene.healPlayer(22); } },
  { id: 'life-drain', name: '生命汲取', rarity: 'rare', type: '回复', description: '击杀普通敌人时抽取微弱生命。', effectText: '击杀普通敌人回复 2 生命', apply: () => undefined },
  ...
  { id: 'spring-echo', name: '源泉残响', rarity: 'epic', type: '回复', description: '源泉回声只会在进入 Boss 房时触发一次。', effectText: '进入 Boss 房回复 18 生命', apply: () => undefined },
